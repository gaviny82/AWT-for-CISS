...
def get_argparser():
    ...
    parser.add_argument("--num_workers", type=int, default=16, help='number of workers (default: 1)')
    ...
    parser.add_argument("--buffer_size", type=int, default=0, help="memory size of exemplars")
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help="Use this to freeze the previous task classifiers in incremental steps"
    )
    parser.add_argument(
        "--freeze_old_and_FE",
        action='store_true',
        default=False,
        help="Use this to freeze the feature extractor and previous task classifiers in incremental steps"
    )
    parser.add_argument(
        "--freeze_all_but_new",
        action='store_true',
        default=False,
        help="Use this to freeze the all except the new task classifier in incremental steps"
    )
    parser.add_argument(
        "--loss_de",
        type=float,
    ...
    parser.add_argument(
        "--loss_kd",
        type=float,
        default=10,  # Distillation on Output
        help="Set this hyperparameter to a value greater than "
    ...
    parser.add_argument("--orig_init", default=False, action="store_true", help="original initialization proposed by MiB")
    parser.add_argument("--copy_bias", default=False, action="store_true", help="copy bias also")
    parser.add_argument("--copy", default=False, action="store_true", help="copy weights instead of addition")
    parser.add_argument("--copy_share", default=0.0, type=float)
    parser.add_argument("--mask_att", default=False, action="store_true", help="enable masking of attribution maps")
    parser.add_argument("--mean_after_max", default=False, action="store_true")
    parser.add_argument("--mean_after_avg", default=False, action="store_true")
    parser.add_argument("--avg_after_mean", default=False, action="store_true")

    parser.add_argument("--att", default=0.0, type=float, help="threshold for selecting most significant channels")
    parser.add_argument("--no_att", default=False, action="store_true", help="disable attribution computation")
    parser.add_argument("--random_channels", default=False, action="store_true", help="transfer weights from randomly selected channels")
    parser.add_argument("--rand", default=0, type=int, help="percentage of randomly selected channels")

    parser.add_argument("--kd_need_labels", default=False, action="store_true")
    parser.add_argument("--kd_category", default=False, action="store_true")
